...
// =======
  ...
  pharName: joi.string().min(3).max(20).messages({
    "any.required": "pharname is required",
    "string.empty": "pharname cant't be empty",
    "string.base": "pharname should be a type of string!",
    "string.min": "pharname should be at least 3 characters!",
    "string.max": "pharname should be less than 20 characters!",
  }),
